...
export default function Home() {
  ...
  const listHandle = () => {
    ...
    if(isLoading){
      return  <div className="animate-spin flex justify-center items-center mt-12 w-2/3 h-70 m-auto"><Image src="/umbrella-icon.png" alt="logo" width={56} height={56} loading="lazy" style={{objectFit: "contain"}}/></div>
    }
    return (<div className="w-2/4 h-100 m-auto flex flex-wrap justify-center gap-x-12 gap-y-4 overflow-y-scroll mt-10 mb-10 scrollbar-custom "> {data?.map(i =>(
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="border-t-2 border-text p-2 w-full mt-auto">
        <p className="text-center">Projeto criado por <a href="https://www.linkedin.com/in/phillip-menezes-desenvolvedor/" target="_blank" className="text-sm border-b border-alternative hover:text-alternative">Phillip Menezes</a>
        </p>
        <p className="text-center">Conteúdos extraídos de <a href="https://www.residentevildatabase.com/" target="_blank" className="text-sm border-b border-alternative hover:text-alternative">Resident Evil Database</a>
        </p>
        <p className="text-center">Siga <a href="https://www.youtube.com/@monidatabase" target="_blank" className="text-sm border-b border-alternative hover:text-alternative">Moni | Database</a>
        </p>
        </footer>
    </div>
  );
